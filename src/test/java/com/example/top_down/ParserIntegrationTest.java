...
class ParserIntegrationTest {
    ...
    void parseIntegrationTestWithFiles() throws Exception {
        ...
        String usersFile = "test_users.txt";
        String moviesFile = "test_movies.txt";
        ...
        // Create files
        createFile(moviesFile, moviesData);
        createFile(usersFile, usersData);

        try {
            // Use the original Parser constructor (file-based)
